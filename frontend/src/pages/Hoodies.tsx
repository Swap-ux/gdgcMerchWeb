...
<section style={{
      ...
      className="bg-[#FFFFED] h-[100vh] pt-[10vh] flex w-full justify-center items-center">
        <div className="flex flex-col gap-y-25">
          <div className="font-jakarta font-bold text-5xl flex justify-center items-center">
            Hoodies
          </div>
          <div className = "w-[80vw] h-86 bg-white border-4 rounded-4xl overflow-hidden flex items-center justify-center">
